import { createRootRoute, Outlet, useLocation, Link, redirect } from '@tanstack/react-router';
...
export const Route = createRootRoute({
  beforeLoad: ({ location }) => {
    // V3: Read directly from the global store for the routing guard
...
// V3: Alias required for our manual TanStack Router setup
export const rootRoute = Route;

function RootComponent() {
  const location = useLocation();
  
  // V3: Subscribe to the store using our strict selector law
